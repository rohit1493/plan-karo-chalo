            ...
            <>
              ...
              {title && (
                <div className="bg-green-50 border border-green-200 rounded-xl px-3 py-2.5">
                  <p className="text-xs text-green-600 font-medium mb-1">Option title (tap to edit)</p>
                  <input
                    type="text"
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    className="text-sm font-semibold text-gray-900 w-full bg-transparent outline-none"
