...
export default function TripPage() {
  const STAGE_LABEL_MAP: Record<string, string> = { date: 'Dates', location: 'Location', stay: 'Stay', activity: 'Activities' }
      ...
      <AnimatePresence>
        {!member && !memberLoading && (
          <JoinModal
            ...
            members={members}
            currentStageLabel={STAGE_LABEL_MAP[stages.find((s) => s.order === trip.current_stage && !s.is_locked)?.type ?? ''] ?? undefined}
